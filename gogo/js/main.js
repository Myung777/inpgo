...
function margiela(){
	if(document.getElementById("margiela").style.display=="block"){
	document.getElementById("triples").style.display="none";
	document.getElementById("inssabag").style.display="none";
	document.getElementById("watch").style.display="none";
	document.getElementById("shoes").style.display="none";
	}else{
	document.getElementById("margiela").style.display="block";
	document.getElementById("triples").style.display="none";
	document.getElementById("inssabag").style.display="none";
	document.getElementById("watch").style.display="none";
	document.getElementById("shoes").style.display="none";
...
function triples(){
	if(document.getElementById("triples").style.display=="block"){
	document.getElementById("margiela").style.display="none";
	document.getElementById("inssabag").style.display="none";
	document.getElementById("watch").style.display="none";
	document.getElementById("shoes").style.display="none";
	}else{
	document.getElementById("triples").style.display="block";
	document.getElementById("margiela").style.display="none";
	document.getElementById("inssabag").style.display="none";
	document.getElementById("watch").style.display="none";
	document.getElementById("shoes").style.display="none";
...
function inssabag(){
	if(document.getElementById("inssabag").style.display=="block"){
	document.getElementById("margiela").style.display="none";
	document.getElementById("triples").style.display="none";
	document.getElementById("watch").style.display="none";
	document.getElementById("shoes").style.display="none";
	}else{
	document.getElementById("inssabag").style.display="block";
	document.getElementById("margiela").style.display="none";
	document.getElementById("triples").style.display="none";
	document.getElementById("watch").style.display="none";
	document.getElementById("shoes").style.display="none";
...
function shoes(){
	if(document.getElementById("shoes").style.display=="block"){
	document.getElementById("margiela").style.display="none";
	document.getElementById("triples").style.display="none";
	document.getElementById("inssabag").style.display="none";
	document.getElementById("watch").style.display="none";
